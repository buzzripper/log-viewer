...
//		{
//			var logViewerData = new AppConfig();

//			try {
//				logViewerData.TimerIntervalSecs = (int)Registry.GetValue(AppKey, "TimerInterval", 1500);
...
//		public void Save(AppConfig logViewerData)
//		{
//			try {
...
//				Registry.SetValue(AppKey, "TimerInterval", logViewerData.TimerIntervalSecs, RegistryValueKind.DWord);
